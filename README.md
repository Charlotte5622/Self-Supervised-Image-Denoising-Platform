...
<img width="1912" height="994" alt="image" src="https://github.com/user-attachments/assets/7df2f069-b4d1-477a-8fc9-cd25f0e83f6b" />
...
## 9. 注意事项
1. 本项目仅用于学术研究与学位论文复现，禁止用于商业用途。
2. 模型权重文件与大型数据集因体积限制未上传，可联系作者获取。
3. 若使用本代码，请注明来源与作者信息。
...
## 11. 版权声明
Copyright © 2026 Trui. All rights reserved.
